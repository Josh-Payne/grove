...
that this expectation value is always greater than or equal to the smallest eigenvalue of :math:`H`, with equality if and only if \Psi is exactly equal to the wave function of the ground state of the studied system.
